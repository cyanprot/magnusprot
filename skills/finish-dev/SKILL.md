---
name: finish-dev
description: Use when implementation is complete and all tests pass — guides branch completion with structured merge/PR/cleanup options
---
...
**Pairs with:**
- **worktree-flow** — Cleans up worktree created by that skill
