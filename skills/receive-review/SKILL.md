---
name: receive-review
description: Use when receiving code review feedback — requires technical verification before implementing, not performative agreement or blind implementation
---
...
**Used alongside:**
- **review-anly** — For requesting reviews (this skill handles receiving them)
- **execute-flow** — Review feedback during plan execution
